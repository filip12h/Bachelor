...
set<Number> sortAlfaVertices(Graph &graph, set<Number> path, set<Number> &alfaVertices);
...
int isPositive(set<Number> vertices, Graph &g, multiset<pair<Number, Number>> blackEdges){
...
bool isLarge(set<Number> vertices, float epsilon){
...
int r(set<Number> vertices, Graph g, multiset<pair<Number, Number>> blackEdges,
        float epsilon, set<set<Number>> connectedComponents){
